...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css-page-top/font.css">
	<?php endif; ?>
	...
	<script>
	//polyfill for IE js include function
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css-page-top/font-ie.css">
	<?php endif; ?>
				...
				<nav class="navBox sp-none">
					<div class="navBox03">
						<ul class="navBox03_list">
							...
							<li class="navBox03_item navBox03_item-title" style="margin-top: 20px;"><a style="cursor: default;">よく見られるページ</a></li>
			...
			<div class="section_inner section_inner-wide">
				<div class="kv_slider">
					...
					<div class="slide-wrap">
						<a href="https://www.aoyama.ac.jp/admission/welcome/" target="_blank">
							<picture>
								<source media="(max-width:799px)" srcset="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/daigakuannaisp.jpg">
								<img src="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/daigakuannai.jpg" alt="動画で知るAGUの学び">
							</picture>

							<div class="kv_text-wrap center white">
																<h2 class="kv_title">受験生向け大学案内</h2>
																										<div class="kv_text"><p class="arrow">動画で知るAGUの学び</p></div>
																							</div>
					...
					<div class="slide-wrap">
						<a href="https://agu-news.a01.aoyama.ac.jp/feature/64" target="">
							<picture>
								<source media="(max-width:799px)" srcset="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/pr_news20210323-4-e1626397418997-2.jpg">
								<img src="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/pr_news20210323-4-e1626397418997.jpg" alt="＜AGU NEWS 特集＞学問およびスポーツ分野等において優秀な成績等を収めた学生・団体を表彰">
							</picture>

							<div class="kv_text-wrap left-lower green">
																<h2 class="kv_title">2020年度 学生表彰・学友会表彰・体育会表彰 </h2>
																										<div class="kv_text"><p class="arrow">＜AGU NEWS 特集＞学問およびスポーツ分野等において優秀な成績等を収めた学生・団体を表彰								</p></div>
																							</div>
					...
					<div class="slide-wrap">
						<a href="https://human-rights.als.aoyama.ac.jp/">
							<picture>
								<source media="(max-width:799px)" srcset="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/AGU_15D_0520-e1622468848574-2.jpg">
								<img src="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/top3.jpg" alt="動画で知るAGUの学び">
							</picture>

							<div class="kv_text-wrap left-center green">
																<h2 class="kv_title">日本初 ヒューマンライツ学科</h2>
																										<div class="kv_text"><p class="arrow">2022年4月 法学部に開設予定</p></div>
																							</div>
						</a>
					</div>

					<div class="slide-wrap">
						<a href="http://newlib.a01.aoyama.ac.jp/" target="_blank">
							<picture>
								<source media="(max-width:799px)" srcset="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/sp4.jpg">
								<img src="https://www.aoyama.ac.jp/wp-content/uploads/2021/07/top_aogaku_newlib_banner_210406_1024px.jpg" alt="動画で知るAGUの学び">
							</picture>

							<div class="kv_text-wrap right-center white">
																<h2 class="kv_title">新図書館棟建築計画公開</h2>
																										<div class="kv_text"><p class="arrow">利用者とともに進化する図書館　2024年オープン予定</p></div>
																							</div>
