...
<?php endif; ?>
							<div class="moviebox_list">
								...
								<div class="subview_wrapeer" data-scroll="once">
									...
									?>
									<div class="subview small-thumb first" data-id="<?php the_field('動画ID_01'); ?>" data-num="1">
										<img
										data-original="<?=$ytbg;?>"
										alt="news"
										class="lazy yt-thumb"
									...
									?>
									<div class="subview small-thumb" data-id="<?php the_field('動画ID_02'); ?>" data-num="1">
										<img
										data-original="<?=$ytbg;?>"
										alt="news"
										class="lazy yt-thumb"
									...
									?>
									<div class="subview small-thumb" data-id="<?php the_field('動画ID_03'); ?>" data-num="1">
										<img
										data-original="<?=$ytbg;?>"
										alt="news"
										class="lazy yt-thumb"
			...
			<div class="section_inner section_inner-wide">
				...
				<div class="flexbox">
					<a href="<?php the_field('facebook_url', 13684); ?>" target="_blank">
						<img
						data-original="<?php bloginfo('template_url'); ?>/images/facebook.png"
						alt="facebook"
						class="lazy"
						loading="lazy">
					</a>
					<a href="<?php the_field('twitter_url', 13684); ?>" target="_blank">
						<img
						alt="twitter"
						data-original="<?php bloginfo('template_url'); ?>/images/twitter.png"
						class="lazy"
						loading="lazy">
					</a>
					<a href="<?php the_field('youtube_url', 13684); ?>" target="_blank">
						<img
						data-original="<?php bloginfo('template_url'); ?>/images/youtube.png"
						alt="youtube"
						class="lazy"
						loading="lazy">
					</a>
					<a href="<?php the_field('instagram_url', 13684); ?>" target="_blank">
						<img
						data-original="<?php bloginfo('template_url'); ?>/images/instagram.png"
						alt="instagram"
						class="lazy"
						loading="lazy">
					</a>
